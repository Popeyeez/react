const Home = () => {
  return (
    <div className="flex">
      <div className="pt-10">
        <div className="w-120 h-125 rounded-md border-black">
          <p className="text-indigo-700 pt-10 pl-10 text-2xl">Hobby</p>
      ...
      <div className="w-120 h-145 bg-gray-900 rounded-2xl">
        <p className="text-indigo-400 pt-10 pl-10 text-xl">Enterprise</p>
        <div className="flex gap-[15px] pl-10 pt-3">
          <div className="flex gap-3">
